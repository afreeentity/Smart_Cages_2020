...
signal = readMat("~/second_step/Neuronal Convergence Dropbox/mehrdadhasanpour88@gmail.com/ILD2019/Paper/files and more/timeseries_75/0-plots/potential/task2/timeseries_h/temperature_male_spraguedawley_overall_h_regular_mean.mat")
S <- unlist(signal)
x <- 1:1800
signal_r <- interp1(x,S, method = "linear")
...
signal = readMat("~/second_step/Neuronal Convergence Dropbox/mehrdadhasanpour88@gmail.com/ILD2019/Paper/files and more/timeseries_75/0-plots/potential/task2/timeseries_h/distance_male_spraguedawley_overall_h_regular_mean.mat")
S <- unlist(signal)
x <- 1:1800
signal_r <- interp1(x,S, method = "linear")
...
signal = readMat("~/second_step/Neuronal Convergence Dropbox/mehrdadhasanpour88@gmail.com/ILD2019/Paper/files and more/timeseries_75/0-plots/potential/task2/timeseries_h/drinking_male_spraguedawley_overall_h_regular_mean.mat")
S <- unlist(signal)
x <- 1:1800
signal_r <- interp1(x,S, method = "linear")
...
signal = readMat("~/second_step/Neuronal Convergence Dropbox/mehrdadhasanpour88@gmail.com/ILD2019/Paper/files and more/timeseries_75/0-plots/potential/task2/timeseries_h/socialinteraction_male_spraguedawley_h_regular_mean.mat")
S <- unlist(signal)
x <- 1:1800
signal_r <- interp1(x,S, method = "linear")
