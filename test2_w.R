...
signal <- readMat("~/second_step/Neuronal Convergence Dropbox/mehrdadhasanpour88@gmail.com/ILD2019/Paper/files and more/timeseries_75/0-plots/potential/task2/timeseries_s/socialinteraction_male_wistar_s_regular_mean.mat")
S <- unlist(signal)
#plot(x=signal_r)
x <- 1:6480000
...
ggsave("~/second_step/Neuronal Convergence Dropbox/mehrdadhasanpour88@gmail.com/ILD2019/Paper/files and more/timeseries_75/0-plots/nonparam/socialinteraction_male_w_avec.png", g, width = 20, height = 20, units = "cm", dpi = 900)
...
ggsave("~/second_step/Neuronal Convergence Dropbox/mehrdadhasanpour88@gmail.com/ILD2019/Paper/files and more/timeseries_75/0-plots/nonparam/socialinteraction_male_w_tvec.png", g, width = 20, height = 20, units = "cm", dpi = 900)
