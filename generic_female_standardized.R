...
ggsave("~/second_step/Neuronal Convergence Dropbox/mehrdadhasanpour88@gmail.com/ILD2019/Paper/files and more/timeseries_75/0-plots/generic/female_standardized_v3_15.png", g, width = 40, height = 40, units = "cm")
